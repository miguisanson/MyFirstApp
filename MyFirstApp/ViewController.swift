...
class ViewController: UIViewController {
    ...
    // IBOutlet means this label is connected from Main.storyboard.
    @IBOutlet weak var displayLabel: UILabel!

    // These are separate outlets for each calculator button.
    ...
    // Each IBAction is connected to one button in Main.storyboard.
